...
import com.example.assetmanager.service.mail.EmailSender;
import com.example.assetmanager.service.mail.EmailValidator;
import com.example.assetmanager.service.user.UserRequest;
import com.example.assetmanager.service.user.UserServiceImpl;
...
public class RegistrationService {
    ...
    public String register(UserRequest request) {
        ...
        String token = userService.signUp(new Users(
                request.getEmail(),
                request.getUsername(),
                request.getPassword(),
                Role.ADMIN
    ...
    public String confirmToken(String token) {
        ...
        userService.enableAppUser(confirmationToken.getUsers().getEmail());
        return "confirmed";
    }
